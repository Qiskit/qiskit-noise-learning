...
"""Tests for qiskit_noise_learning.aer_executor.broadcast_sample.broadcast_sample()."""
...
from qiskit_noise_learning.aer_executor.broadcast_sample import broadcast_sample


@pytest.fixture
def cx_item(fez_backend):
...
@pytest.fixture
def param_item_no_broadcast(fez_backend):
...
@pytest.fixture
def param_item_mixed(fez_backend):
...
def test_broadcast_sample_no_broadcast_axes(cx_item):
...
def test_broadcast_sample_all_broadcast_axes(param_item_mixed):
    """Broadcast axes produce the correct leading shape."""
    item = param_item_mixed
